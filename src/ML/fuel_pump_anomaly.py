...
data_path = None
for candidate in [
    Path("Data/fuel_pump.csv"),
    Path("../Data/fuel_pump.csv"),
    Path("src/ML/Data/fuel_pump.csv"),
    Path("C:/Users/Jevil/OneDrive/Desktop/bob/bob-ai-hackathon-NexGen/src/ML/Data/fuel_pump.csv"),
]:
    if candidate.exists():
        data_path = candidate
        break
...
model_path = model_dir / "fuel_pump_anomaly_model.pkl"
