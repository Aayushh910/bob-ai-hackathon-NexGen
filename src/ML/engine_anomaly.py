...
data_path = None
for candidate in [
    Path("Data/engine.csv"),
    Path("../Data/engine.csv"),
    Path("src/ML/Data/engine.csv"),
    Path("C:/Users/Jevil/OneDrive/Desktop/bob/bob-ai-hackathon-NexGen/src/ML/Data/engine.csv"),
]:
    if candidate.exists():
        data_path = candidate
        break
...
model_path = model_dir / "engine_anomaly_model.pkl"
