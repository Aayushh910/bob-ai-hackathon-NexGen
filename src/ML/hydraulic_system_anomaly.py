...
data_path = None
for candidate in [
    Path("Data/hydraulic_system.csv"),
    Path("../Data/hydraulic_system.csv"),
    Path("src/ML/Data/hydraulic_system.csv"),
    Path("C:/Users/Jevil/OneDrive/Desktop/bob/bob-ai-hackathon-NexGen/src/ML/Data/hydraulic_system.csv"),
]:
    if candidate.exists():
        data_path = candidate
        break
