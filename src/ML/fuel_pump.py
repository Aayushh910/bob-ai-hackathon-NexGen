...
try:
    df = pd.read_csv("../Data/fuel_pump.csv")
except Exception:
    try:
        df = pd.read_csv("Data/fuel_pump.csv")
    except Exception:
        try:
            df = pd.read_csv("src/ML/Data/fuel_pump.csv")
        except Exception:
            df = pd.read_csv(
                "C:/Users/Jevil/OneDrive/Desktop/bob/bob-ai-hackathon-NexGen/src/ML/Data/fuel_pump.csv"
            )

print("Fuel Pump dataset successfully loaded into pandas DataFrame.")
print("=" * 60)
print("DATASET SHAPE:")
...
model_path = model_dir / "fuel_pump_failure_model.pkl"
...
print("\n3. MATRIX BREAKDOWN:")
print("-" * 50)
print(f"  True Negatives  (TN): {tn:>5}  (Correctly identified normal fuel pumps)")
...
# =====================================================================
# 6. INFERENCE ON TEST DATASET (fuel_pump_test.csv)
# =====================================================================
test_data_path = None
for candidate in [
    Path("Data/fuel_pump_test.csv"),
    Path("../Data/fuel_pump_test.csv"),
    Path("src/ML/Data/fuel_pump_test.csv"),
    Path("C:/Users/Jevil/OneDrive/Desktop/bob/bob-ai-hackathon-NexGen/src/ML/Data/fuel_pump_test.csv"),
]:
    if candidate.exists():
...
if test_data_path is not None:
    ...
    assert len(df_test) == 1004, f"Expected 1004 rows, got {len(df_test)}"
